<!--#include file="/resources/header.php" -->
            <script language="JavaScript">
                ...
                function getBooks() {
                    ...
                    // Page url
                    var url = '/books/tables/' + Download + '.html';
            ...
            <div id="noscript" style="text-align: center">
                ...
                <table border="1"  style="border-collapse: collapse;" cellpadding="5">
                    <tr>
                        <td> <a href="/permalink.php?link=books/tables/comic">comic</a> </td>
                        <td> Comics (Main series) </td>
                    </tr>
                    <tr>
                        <td> <a href="/permalink.php?link=books/tables/mscomic">mscomic</a> </td>
                    ...
                    <tr>
                        <td> <a href="/permalink.php?link=books/tables/books">books</a> </td>
