...
<!--#elif expr="$link = episodes/1z6" -->Color Corrected by ZR Season 6 (1080p)
...
<!--#elif expr="$link = episodes/7z6" -->Color Corrected by ZR Season 6 (720p)
...
<!--#elif expr="$link = episodes/1i6" -->iTunes US Season 6 (1080p)
...
<!--#elif expr="$link = episodes/1sc1" -->Scootaloo Corrected (x265/HEVC) Season 1 (1080p)
...
<!--#elif expr="$link = episodes/1t6" -->TVRip by Spazz Season 6 (1080p)
...
<!--#elif expr="$link = episodes/7l6" -->Low quality encode, Season 6 (720p)
...
<!--#elif expr="$link = episodes/7lz6" -->Low quality encode, color corrected, Season 6 (720p)
...
<!--#elif expr="$link = ypsubs/ypsub6" -->YP Subtitles for MLP FiM Season 6
