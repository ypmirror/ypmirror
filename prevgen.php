<!--#include file="header.php" -->
            <script language="JavaScript">
                ...
                function getPonies() {
                    ...
                    // Page url
                    var url = 'prevgen/g' + DownloadSeason.charAt(0) + DownloadSource + DownloadSeason.charAt(1) + '.html';
            ...
            <div id="noscript" style="text-align: center">
                ...
                <table border="1"  style="border-collapse: collapse;" cellpadding="5">
                    ...
                    <tr>
                        <td> <a href="permalink.php?link=prevgen/g1d1">g1d1</a> </td>
                        <td> My Little Pony and Friends (G1) </td>
                    </tr>
                    <tr>
                        <td> <a href="permalink.php?link=prevgen/g1d2">g1d2</a> </td>
                        <td> My Little Pony Tales (G1) </td>
                    </tr>
                    <tr>
                        <td> <a href="permalink.php?link=prevgen/g3d1">g3d1</a> </td>
                        <td> My Little Pony (G3) </td>
                    </tr>

                    <tr> <th colspan="2"> Color Corrected </th> </tr>
                    <tr>
                        <td> <a href="permalink.php?link=prevgen/g1z1">g1z1</a> </td>
                        <td> My Little Pony and Friends (G1) </td>
                    </tr>
                    <tr>
                        <td> <a href="permalink.php?link=prevgen/g3z1">g3z1</a> </td>
                        <td> My Little Pony (G3) </td>
                    </tr>
                </table>
            </div>
